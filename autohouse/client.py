...
# values = "\u003Curn:subj\u003E \u003Curn:pred\u003E \u003Curn:obj\u003E."
# headers = {"Accept": "application/x-turtle, text/turtle, application/rdf+xml, text/plain, application/x-trig, text/x-nquads, application/trix", "SD-Connection-String": ""}
# request_url = 'http://localhost:5820/myDb/add'
# r = requests.post(request_url, headers=headers,data=values, auth=('admin', 'admin'))
# print r.status_code
# print(r.headers)
# print(r.text)
